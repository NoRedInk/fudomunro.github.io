describe('On the home page', () => {
    ...
    it('Can view a menu item', () => {
      ...
      cy.get('#button_container > .w3-button').click()
    ...
    it('Can toggle the contact form', () => {
      ...
      cy.get('#_541jkl_modal > .w3-modal-content > .w3-black > .w3-button').click()
      // cy.contains('div', 'hide contact').click()
      // NOTE TO QA: Let's check with product owner to confirm what functionality should be for the `show/hide contact` button
